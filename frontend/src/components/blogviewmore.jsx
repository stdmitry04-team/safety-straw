...
import blog_middown_image from "../images/strawtint.png"; // Image for second row, middle
import blog_rdown_image from "../images/bartint.png"; // Image for second row, right
