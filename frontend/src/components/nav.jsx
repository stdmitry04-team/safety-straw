    ...
    <nav className="navbar">
      <div className="navbar-left">
        <a href="#" className="navbar-logo" onClick={topFunction}>
          ...
          <img
            src={logo_text}
            alt="Safety Straw Logo"
            className="logo-text desktop-logo-text"
          />
          <img
            src={mobileLogoText}
            alt="Safety Straw Logo"
            className="logo-text mobile-logo-text"
          />
        </a>
      </div>
      ...
      <div className="navbar-right">
        <div className="desktop-links">
          ...
          <button onClick={openModal} className="join-btn">
            Join Waitlist
          </button>
        </div>
      ...
      {isDropdownOpen && (
        <div className="dropdown-menu">
          <a href="#" className="nav-link" onClick={topFunction}>
            SAFETY STRAW
          </a>
          <a
            href="#footer"
