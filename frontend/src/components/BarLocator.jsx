...
export default function BarLocator() {
  const addresses = [
    {
      name: "JERRY’S SPORTS BAR",
      phone: "(906) 906-9069",
      address: "1111 A ANDERSON AVE, ANDORRA, AZ 22222",
      distance: "1.47 miles",
    },
    {
      name: "HARPER’S",
      phone: "(555) 555-5555",
      address: "555 US HIGHWAY 5, FLORENCE, WI, 77777",
      distance: "3.58 miles",
    },
    {
      name: "AURORA LIQUORS",
  ...
  return (
    <div className="bar-locator">
      ...
      <div className="bar-locator-container">
        ...
        <div className="bar-locator-columns">
          <div className="bar-locator-left-col">
          ...
          <div className="bar-locator-right-col">
            <div className="bar-locator-map">
              <LoadScript
                googleMapsApiKey="AIzaSyDU3h2yXSmgBHi8SfXvakNLPqP5sVhQ-aA"
                libraries={["places"]}
              >
                <GoogleMap
